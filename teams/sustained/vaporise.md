...
Because he is a Pyro DPS he does the most damage when he creates **Elemental Reactions.** He relies on the **Reverse Vaporise Reaction** which **multiplies** his damage by **1.5x**, and with a character that can consistently **apply Hydro** like **Xingqiu with his Elemental Burst active**, **every attack** that Diluc does **will be be a Vaporize Reaction**. While the Melt Reaction gives Diluc bigger numbers it is **less consistent** which means that it will be **less total DPS** compared to Reverse Vaporize in the long run.
